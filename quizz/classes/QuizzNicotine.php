<?php
class QuizzNicotine extends ObjectModel
{
    ...
    public static $definition = array(
        'table' => 'quizz_nicotine',
        'primary' => 'id_nicotine',
        'multilang' => true,
		'multishop' => false,
		'multilang_shop' => false,
        'fields' => array(
			'id_nicotine'  => 					['type' => self::TYPE_INT, 'validate' => 'isUnsignedInt'],            
			...
			'level' =>           	array('type' => self::TYPE_HTML, 'lang' => TRUE, 'validate' => 'isString', 'size' => 3999999999999),
        ),
    );
	public function __construct($id=null,$id_lang=null)
    {
        ...
        {
			if ($id_lang){
				$sql_select = "SELECT q.`".$this->identifier."`,q.delimiter1,q.delimiter2,ql.level,ql.content,ql.id_lang FROM " . _DB_PREFIX_ . $this->table." q
